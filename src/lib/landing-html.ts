// Landing page markup, ported from the provided design.
...
<!-- UrShop - Subscription & Feature Comparison (Liquid Glass Edition) -->
<!DOCTYPE html><html lang="en" style=""><head>
<meta charset="utf-8">
<meta content="width=device-width, initial-scale=1.0" name="viewport">
<title>UrShop - Subscription Plans &amp; Feature Comparison</title>
...
<body class="text-[#0F172A] antialiased overflow-x-hidden selection:bg-[#08C0D8] selection:text-slate-900 min-h-screen" style="background-color: #ffffff;">
