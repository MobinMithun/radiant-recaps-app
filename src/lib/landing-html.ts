...
<header id="site-navigation" class="fixed top-0 w-full z-50 transition-all duration-300">
...
<div class="how-it-works-title-block text-center max-w-2xl mx-auto mb-16">
...
<div class="how-it-works-data-line hidden md:block absolute -top-8 h-[1px] bg-slate-300/80 z-0">
<span class="how-it-works-data-packet how-it-works-data-packet-left"></span>
<span class="how-it-works-data-packet how-it-works-data-packet-middle"></span>
<span class="how-it-works-data-packet how-it-works-data-packet-right"></span>
</div>
...
<div class="how-it-works-data-stem how-it-works-data-stem-1 w-[1px] h-full bg-slate-300"></div>
...
<div class="relative flex flex-col pt-6 md:pt-8">
<div class="hidden md:flex flex-col items-center absolute -top-8 left-1/2 -translate-x-1/2 h-8 pointer-events-none z-20">
<div class="how-it-works-data-stem how-it-works-data-stem-2 w-[1px] h-full bg-slate-300"></div>
...
<div class="relative flex flex-col pt-6 md:pt-8">
<div class="hidden md:flex flex-col items-center absolute -top-8 left-1/2 -translate-x-1/2 h-8 pointer-events-none z-20">
<div class="how-it-works-data-stem how-it-works-data-stem-3 w-[1px] h-full bg-slate-300"></div>
